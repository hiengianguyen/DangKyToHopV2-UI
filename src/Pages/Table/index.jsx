    ...
    <BoxRadius>
        ...
        <div className="flex items-center gap-8 bg-orange-50 border-s-4 border-orange-400 mb-10 py-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <span className="text-orange-800">
              Việc thay đổi môn học trong tổ hợp có thể ảnh hưởng đến dữ liệu <b className="text-yellow-800">đăng ký nguyện vọng</b> của học
              sinh. Vui lòng kiểm tra kỹ số lượng lớp dự kiến và các môn chuyên đề trước khi lưu thay đổi.
            </span>
          </div>
        </div>
        <div className="flex gap-8">
          ...
          <div className="flex justify-between items-center w-100 rounded-lg bg-blue-50 border border-blue-100 p-4">
            ...
            <div className="rounded-full size-20 bg-blue-200 flex justify-center items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="size-12" viewBox="0 0 24 24" fill="none">
                <path
                  d="M3 15L3.92359 3.91695C3.96678 3.39866 4.40004 3 4.92013 3H19.0799C19.6 3 20.0332 3.39866 20.0764 3.91695L21 15M3 15V20C3 20.5523 3.44772 21 4 21H20C20.5523 21 21 20.5523 21 20V15M3 15H9C9 16 9.6 18 12 18C14.4 18 15 16 15 15H21"
                  stroke="#000000"
                  stroke-linejoin="round"
                />
              </svg>
      ...
      {dataTable.combinations &&
        dataTable.combinations.map((item, index) => {
          ...
          return (
            <ModalEditTable key={index} isShow={isShowModal} setShow={setIsShowModal} combination={item} setCombinations={setDataTable} />
          );
        })}
    </BoxRadius>
  );
