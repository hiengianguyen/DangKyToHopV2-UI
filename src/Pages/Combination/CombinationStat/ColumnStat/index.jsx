    ...
    return ( 
        <div className="flex flex-col items-center w-100 mt-4">
            <div className="w-full h-full relative group">
                <div title={ 'Có ' + value + " hồ sơ có tổng điểm 3 môn "+ title + 'đ'} className="top-auto w-full absolute bottom-0 text-transparent bg-indigo-300 rounded-t-md group-hover:bg-indigo-500 transition-all cursor-pointer" style={{height: `${((value/max)*100).toFixed(0)}%`}}>
