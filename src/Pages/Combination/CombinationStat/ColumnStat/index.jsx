    ...
    <div className="flex flex-col items-center w-100 mt-4">
      <div className={"w-full h-full relative group " + (bg && "bg-" + bg + "-100")}>
        <div
          ...
          style={{ height: `${((value / max || 0.01) * 100).toFixed(0)}%` }}
        >
          <span className="text-transparent fw-bold group-hover:text-indigo-800 transition-all absolute -top-5 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            {value}
          </span>
        </div>
      </div>
